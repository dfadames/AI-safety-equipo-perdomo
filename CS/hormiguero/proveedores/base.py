    ...
    ToolSpec("escribir_canal",
             ...
             {"type": "object",
              "properties": {
                  "mensaje": {"type": "string"},
                  "para": {"type": "string",
                           "description": ("id del auditor destinatario, si el mensaje es "
                                           "solo para el (ej. 'B'). Si se omite, lo reciben "
                                           "todos.")},
              },
              "required": ["mensaje"]}),
    ToolSpec("leer_canal",
             ...
             {"type": "object",
              "properties": {
                  ...
                  "cited_by_agent": {
                      ...
                      "description": ("ids de los mensajes del canal de donde sacaste cada "
                                      "parte que no encontraste vos mismo (opcional).")},
              },
              "required": ["valor"]}),
