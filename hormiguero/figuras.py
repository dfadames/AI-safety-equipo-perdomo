"""
Las figuras, las tablas y los numeros del paper, desde results/.
...
def numeros(filas, replicas, auditorias, d1, d2, d3, efectivas, version=VERSION_TAREA, fallidos=0) -> str:
    ...
    L.append("Generated by `py -m hormiguero.figuras` from `results/`. Do not edit by hand: "
...
def main(argv=None):
    ap = argparse.ArgumentParser(prog="hormiguero.figuras",
                                 description="Figuras, tablas y numeros del paper, desde results/.")
    ap.add_argument("--resultados", default=None, help="por defecto, results/ en la raiz del repo")
